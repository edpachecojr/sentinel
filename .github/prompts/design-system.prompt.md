...
[PREENCHA ANTES DE ENVIAR O PROMPT]
    ...
    •	Nome do projeto: NeoLegis
    •	O que faz: A NeoLegis é uma plataforma web desenvolvida para apoiar gabinetes parlamentares na gestão diária de demandas, compromissos e relacionamento com a população. Tudo integrado, organizado e acessível, com foco em eficiência operacional e transparência.
    •	Para quem: Gabinetes parlamentares (vereadores, deputados estaduais, deputados federais) e suas equipes de assessoria.
    •	Sensação desejada: Organização, clareza, profissionalismo, mas com um toque humano e acessível. Queremos que os usuários sintam que estão no controle total de suas demandas e compromissos, sem se sentirem sobrecarregados.
    •	O que NÃO quer parecer: um software burocrático, frio ou complexo. Evitar a sensação de "mais um sistema complicado" — a interface deve ser intuitiva e acolhedora, mesmo para quem não é tech-savvy. Evite app genérico, ou a sensação de template pronto.
    •	Light mode, dark mode ou ambos: AMBOS, com identidade consistente em ambos.
    •	Referência de energia (opcional): O TailAdmin é uma referência de energia que gostamos — tem um ar profissional e organizado, mas falta personalidade. Queremos algo com a mesma clareza, mas com mais alma e identidade visual única.
